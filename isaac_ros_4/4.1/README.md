# Isaac Manipulation layer (Isaac ROS 4.1) — `isaac-ros` CLI integration
...
`CONFIG_DOCKER_SEARCH_DIRS`. Do the same for `4.1/`.
...
Notes:
- If you **also** have the `4.0/` directory in `CONFIG_DOCKER_SEARCH_DIRS`, put `4.1/` **before** `4.0/`
